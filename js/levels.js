...
const LEVELS = [
  ...
  },
  {
    ...
    polygons: [
      [
        [-5, -8], [64, -8], [64, 13.8], [58, 15.2], [53, 16.3], [47, 17],
        [41, 17.5], [36, 17.3], [33.5, 16.6], [31, 15.5], [30.2, 15],
        [23, 18.4], [17, 17.7], [12, 18.1], [7, 17.3], [0, 17.3], [-5, 17.3],
        [-5, 10], [29.5, 10], [30.5, 8.9], [28, 8.9], [25.5, 8.3], [22, 8.3],
        [17, 8.1], [14, 6.7], [11, 6.7], [8, 8], [0, 8], [-5, 8],
      ],
      // the rail: a thin floating blade ending in the curl-back hook.
      // Generated by _scratch_gen_1_9.js
      [
        [34.5, 11.6], [44, 11.6], [52, 10.33], [52.5, 10.33], [52.67, 10.33],
        [52.85, 10.31], [53.02, 10.28], [53.19, 10.24], [53.36, 10.18],
        [53.52, 10.12], [53.67, 10.04], [53.82, 9.95], [53.97, 9.86],
        [54.11, 9.75], [54.24, 9.63], [54.36, 9.51], [54.47, 9.37],
        [54.57, 9.23], [54.67, 9.08], [54.75, 8.93], [54.82, 8.77],
        [54.88, 8.61], [54.93, 8.44], [54.96, 8.27], [54.99, 8.09],
        [55, 7.92], [55, 7.75], [54.99, 7.57], [54.96, 7.4], [54.93, 7.23],
        [54.88, 7.06], [54.82, 6.9], [54.75, 6.74], [54.67, 6.58],
        [54.57, 6.43], [54.47, 6.29], [54.36, 6.16], [54.24, 6.03],
        [54.11, 5.92], [53.97, 5.81], [53.82, 5.71], [53.67, 5.63],
        [53.52, 5.55], [53.36, 5.48], [53.19, 5.43], [53.02, 5.39],
        [52.85, 5.36], [52.67, 5.34], [52.5, 5.33], [52.33, 5.34],
        [52.15, 5.36], [51.98, 5.39], [51.62, 4.55], [52.06, 4.25],
        [52.57, 4.01], [53.13, 3.84], [53.74, 3.77], [54.39, 3.78],
        [55.01, 3.98], [55.52, 4.36], [55.97, 4.82], [56.36, 5.33],
        [56.67, 5.89], [56.9, 6.49], [57.04, 7.11], [57.1, 7.75],
        [57.07, 8.39], [56.94, 9.02], [56.73, 9.63], [56.44, 10.2],
        [56.07, 10.73], [55.64, 11.2], [55.14, 11.6], [54.59, 11.93],
        [54, 12.18], [53.38, 12.35], [52.74, 12.43], [49, 12.76],
        [46.5, 12.78], [45, 12.95], [35.2, 12.95],
      ],
    ],
    start: { x: 2.5, y: 7.25 },
    burgers: [
      [12.5, 6.0],    // warmup roller crest
      [21, 7.5],      // on the build flat
      [40, 10.15],    // on the thin rail, head-high over the gorge
      [47.3, 9.4],    // on the rail's rise, in both directions' path
      [54.4, 7.33],   // on the hook's inner wall, swept up the climb
      [52.5, 6.0],    // the hook apex: collected upside down
      [12.5, 17.4],   // gorge floor, on the ride out
      [7.5, 16.6],    // gorge floor
    ],
    goal: [4.5, 16.55],
  },
];
...
const TRACKS = [
  { id: 'easy',   label: 'Easy',   color: '#9be08a', length: 10, levels: [LEVELS[0], LEVELS[1], LEVELS[2], LEVELS[3], LEVELS[4], LEVELS[5], LEVELS[6], LEVELS[7], LEVELS[8]] },
