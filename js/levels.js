...
const LEVELS = [
  ...
  },
  {
    ...
    // outer wall through two full inversions, with the rock arm between
    // the windings thinning from ~1.4 to ~0.5 the deeper you go. Speed
    // is commitment: the dive banks more than enough to hold the first,
    // widest inversion, and every lap inward needs less. The corridor
    // dead-ends at the heart of the spiral, where the bucket waits just
    // before the cap. Slot walls generated by _scratch_gen_1_9.js.
    polygons: [
      [
        // ceiling: open sky
        [-5, -8], [62, -8],
        ...
        [33.11, 12.23], [34.73, 13.72], [36.34, 15.22], [37.95, 16.72],
        // inner trace: corridor ceiling spiraling in (arm faces)
        [39.71, 18.36], [40.25, 18.8], [40.83, 19.2], [41.43, 19.55], [42.07, 19.85], [42.73, 20.09],
        [43.4, 20.28], [44.09, 20.4], [44.79, 20.47], [45.49, 20.48], [46.18, 20.43], [46.87, 20.32],
        [47.55, 20.15], [48.21, 19.92], [48.85, 19.63], [49.46, 19.29], [50.04, 18.89], [50.57, 18.44],
        [51.06, 17.94], [51.51, 17.4], [51.89, 16.82], [52.23, 16.2], [52.49, 15.56], [52.7, 14.89],
        [52.84, 14.2], [52.9, 13.5], [52.9, 12.8], [52.83, 12.11], [52.68, 11.42], [52.46, 10.76],
        [52.18, 10.12], [51.82, 9.52], [51.41, 8.95], [50.93, 8.44], [50.4, 7.98], [49.82, 7.59],
        [49.21, 7.26], [48.56, 7], [47.88, 6.82], [47.19, 6.72], [46.49, 6.69], [45.79, 6.75],
        [45.11, 6.89], [44.44, 7.11], [43.81, 7.41], [43.22, 7.78], [42.68, 8.22], [42.21, 8.73],
        [41.8, 9.3], [41.47, 9.92], [41.23, 10.57], [41.08, 11.26], [41.03, 11.95], [41.08, 12.65],
        [41.23, 13.33], [41.48, 13.98], [41.82, 14.59], [42.26, 15.14], [42.77, 15.62], [43.35, 16.01],
        [43.98, 16.3], [44.65, 16.49], [45.35, 16.56], [46.04, 16.52], [46.72, 16.35], [47.36, 16.08],
        [47.94, 15.69], [48.44, 15.2], [48.83, 14.63], [49.1, 13.99], [49.24, 13.3], [49.23, 12.61],
        [49.08, 11.93], [48.78, 11.3], [48.34, 10.76], [47.79, 10.35], [47.15, 10.08], [46.49, 9.98],
        [45.86, 10.05], [45.29, 10.27], [44.82, 10.61], [44.47, 11.04], [44.25, 11.52], [44.17, 12.01],
        [44.22, 12.48], [44.38, 12.89], [44.63, 13.22], [44.94, 13.46], [45.28, 13.6], [45.61, 13.64],
        [45.91, 13.6], [46.17, 13.52], [46.38, 13.41],
        // dead-end cap at the spiral's heart
        [46.83, 13.31], [47.28, 13.4], [47.67, 13.65], [47.92, 14.03], [48.02, 14.48], [47.93, 14.93], [47.68, 15.31],
